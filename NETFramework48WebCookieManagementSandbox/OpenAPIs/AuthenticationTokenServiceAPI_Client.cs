...
{
    public partial class AuthenticationTokenServiceAPI
    {
        private string AppId { get; set; }
        private Func<string> RequestAuthorizationHeaderResolver { get; set; }
        public AuthenticationTokenServiceAPI(Func<string> requestAuthorizationHeaderResolver, string baseUrl, string appId):this(new HttpClient()) {
